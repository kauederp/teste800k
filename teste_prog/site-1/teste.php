...
<head>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" href="https://lanternasfx.com/assets/img/favicon.png" type="image/x-icon">
    <link rel="icon" href="https://lanternasfx.com/assets/img/favicon.png" type="image/x-icon">
    ...
    <!-- RESET -->
    <link rel="stylesheet" href="./files/css/reset.css?cache=33">
    <!-- BOOTSTRAP -->
    ...
    <!-- MAIN -->
    <link rel="stylesheet" href="./files/css/main.css?cache=33">
    <!-- AOS -->
    <link rel="stylesheet" href="./files/css/aos.css?cache=33">
    <!-- FONT-AWESOME -->
    ...
    <link rel="stylesheet" href="./files/css/toastr.min.css">
</head>

<body cz-shortcut-listen="true" class="row m-0 p-0">
<header>
    <div class="container">
        <div class="row">
...
<section class="home">
    <div class="container">
        <h1 class="headline text-center">A lanterna mais <br/><span>utilizada no mundo</span></h1>
        <p class="text-center"><b>OFERTA POR TEMPO LIMITADO:</b> <br/> Você ganhou até <b>29% de desconto</b> e <b>1
                ...
                <div class="p-3">
                    <a href="#checkout" target="_self"
                       class="btn-chamada smoth-scroll margin-auto pulse">
                        <i class="fas fa-check-double"></i> COMPRAR AGORA <br/>
                        <br><span>
            ...
            <div class="col-lg-7 my-auto">
                ...
                <div class="text-center">
                    <div class="p-3">
                        <a href="#checkout" target="_self"
                           class="btn-chamada smoth-scroll margin-auto pulse">
                            <i class="fas fa-check-double"></i> ENCOMENDAR AGORA <br/>
                            <br><span>
                                    Satisfação garantida ou seu dinheiro de volta!
                                </span>
                        </a>
...
<section class="beneficios section-padding">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="p-3">
                    <a href="#kits" class="btn-chamada smoth-scroll margin-auto pulse">
                        <i class="fas fa-check-double"></i> Quero comprar <br/>
                        <br><span>
                                Satisfação garantida ou seu dinheiro de volta!
                            </span>
                    </a>
            ...
            <div class="col-12">
                <div class="row justify-content-center">
                    ...
                    <div class="swiper mySwiper swiper-initialized swiper-horizontal swiper-pointer-events">
                        <div class="swiper-wrapper" id="swiper-wrapper-459a39dd109fb118f" aria-live="off" style="transition-duration: 300ms; transform: translate3d(0px, 0px, 0px);">
                            <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 4" style="width: 350px; margin-right: 30px;">
                                <img style="width: 40%;" src="files/img/depoimento-1.jpg">
                                <img style="width: 45%;"  src="files/img/depoimento-4.jpg">
                            </div>
        ...
        <div class="row py-3">
            ...
            <div class="col-lg-5">
                <p>O Envio é <strong>IMEDIATO</strong> para todos estados do Brasil! O prazo para entrega é na média de
                    3 a 12 dias úteis com código de rastreamento. </p><br/>
...
<section class="garantia section-padding">
    <div class="container">
        <h1 class="headline text-center">SATISFAÇÃO GARANTIDA OU<br/><span>SEU DINHEIRO DE VOLTA!</span></h1>
        <div class="row">
            ...
            <div class="col-md-8 my-auto">
                ...
                <div class="text-center p-3">
                    <a href="#kits" class="btn-chamada smoth-scroll margin-auto pulse">
                        <i class="fas fa-check-double"></i> COMPRAR COM GARANTIA <br/>
                        <br><span>
                                Satisfação garantida ou seu dinheiro de volta!
                            </span>
                    </a>
...
<section class="seguro section-padding">
    <div class="container">
        <h1 class="headline text-center theme-color">NÃO ESTÁ ACOSTUMADO <br/>A COMPRAR <span>PELA INTERNET?</span></h1>
        <div class="row">
            <div class="col-lg-3 text-center">
                <div class="item">
                    <img src="./files/img/confiavel.png" class="img-fluid" alt="">
                    <p>
                        Seus dados pessoais são <br/>
            ...
            <div class="col-lg-3 text-center">
                <div class="item">
                    ...
                    <p>
                        Entrega para todo Brasil de <br/>
    ...
    <div class="container">
        ...
        <div id="">
            <div class="desktop">
                <div class="row">
                    ...
                    <div class="col-md" style="padding: 5px">
                        <a href="<?php echo($kit2) ?>">
                            <img class="btn-pulse bg-transparent" width="100%" src="files/img/kit3-desk.png?cache=3"
                ...
                <br/><br/>
                <div style="width: 100%">
                    <a href="<?php echo($kitM) ?>"><img class="btn-pulse" width="100%"
...
<footer>
    <div class="container">
        <div class="row">
            ...
            <div class="pt-3 col-lg-3 col-md-6">
                <h2>LINKS ÚTEIS</h2>
                <a href="https://cademeupedido.log.br/?t=emU=">Rastrear pedido</a><br/>
                <a href="https://lanternasfx.com/termos-e-condicoes">Termos e Condições</a><br/>
                <a href="https://lanternasfx.com/politica-de-privacidade">Política de Privacidade</a><br/>
            </div>
            <div class="pt-3 col-lg-3 col-md-6">
                <h2>DÚVIDAS?</h2>
                <a>Fale conosco aqui: <br/></a>
                <a href="https://suportevendas.com/">Suporte</a><br/>
            </div>
            <div class="pt-3 col-lg-3 col-md-6">
                <h2>SITE SEGURO</h2>
                <img src="./files/img/selo-seguranca.png" class="img-fluid" alt="Métodos de pagamento">
                <h2 class="pt-3">VERIFICADO PELO GOOGLE</h2>
                <a href="https://transparencyreport.google.com/safe-browsing/search?url=https://lanternasfx.com"
        ...
        <div class="row">
            <div class="col-12">
                <p class="text-center"><?php echo date('Y');?> © Actual Produtos - Todos os direitos reservados <br/></>
            </div>
        </div>
    </div>
</footer>
...
<style>
    ...
    .modal-content {
        ...
        margin: 2% 15%  ; /* 15% from the top and centered */
        padding: 20px;
